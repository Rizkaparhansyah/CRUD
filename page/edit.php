            ...
            <div class="card-body">
                ...
                if ($error == "true") : ?>
                    <div class="alert alert-danger" role="alert">
                        Proses gagal, pastikan semua formulir terisikan
                    </div>
                <?php endif; ?>
                <div class="row">
                ...
                <form method="POST" action="<?php echo base_url . 'process/process_edit.php'?>">
                <input name="id" value="<?php echo $pegawai['id'] ?>" type="hidden">
                <div class="mb-3">
